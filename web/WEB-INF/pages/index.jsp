...
<div class="container">
    ...
    <div>
        <form class="form-inline" role="form" action="/add_product" method="post">
            <input type="submit" class="btn btn-default" value="Add new product">
        </form>

        <form class="form-inline" role="form" action="/get_product" method="post">
            <input type="submit" class="btn btn-default" value="Get all product">
        </form>

        <form class="form-inline" role="form" action="/get_cart" method="post">
            <input type="submit" class="btn btn-default" value="Корзина">
        </form>
    </div>
